...
class Address extends MagentoAddress
{
    ...
    protected function _initAttributes()
    {
        ...
        $this->_attributes[self::COLUMN_INCREMENT_ID] = [
            'code' => self::COLUMN_INCREMENT_ID,
            'is_required' => false,
            'type' => 'int',
            'is_static' => true
        ];

        $this->_specialAttributes = array_merge($this->_specialAttributes, [
            self::COLUMN_INCREMENT_ID
        ]);
    ...
    public function customChangeData($rowData)
    {
        ...
        $columnIncrementId = self::COLUMN_INCREMENT_ID;
