    ...
    $.extend(timepickerPrototype, {
        ...
        _updateDateTime: function (dp_inst) {
            ...
            if (!this._defaults.showTimepicker) {
                ...
                if ($.datepicker._get(dp_inst, 'isTime')
                    && ($.datepicker._get(dp_inst, 'mpDateFormat') || $.datepicker._get(dp_inst, 'mpTimeFormat'))) {
                    var mpTimeFormat = $.datepicker._get(dp_inst, 'mpTimeFormat');

                    formattedDateTime = $.datepicker.formatTime(mpTimeFormat, $.datepicker._get(dp_inst, 'timepicker'), {});
                }
                this.$input.val(formattedDateTime);
            }
