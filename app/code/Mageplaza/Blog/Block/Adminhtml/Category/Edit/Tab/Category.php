...
use PPGroup\Cms\Model\Page\Source\PageLayout as BasePageLayout;
use Mageplaza\Blog\Model\Config\Source\SideBarLR as SideBarOptions;
/**
 * Class Category
...
class Category extends Generic implements TabInterface
{
     ...
     * @param BasePageLayout $layoutOptions
     * @param SideBarOptions $sidebarOption
     * @param array $data
     */
    public function __construct(
        ...
        $this->_sidebarOption = $sidebarOption;
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('category_layout', 'select', [
