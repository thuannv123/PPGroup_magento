...
namespace PPGroup\Blog\Block\Category;
...
class Menu extends Template
{
    ...
    public function getMenuHtml($parentCategory)
    {
        ...
        $html = '<a href="' . $categoryUrl . '" class="ui-corner-all level'. $parentCategory->getLevel()
            .'" tabindex="-1" role="menuitem" style="width:20%; padding:10px">'
            . '<span>' .$parentCategory->getNameStore($parentCategory->getId(),$this->storeManager->getStore()->getId()). '</span></a>';
