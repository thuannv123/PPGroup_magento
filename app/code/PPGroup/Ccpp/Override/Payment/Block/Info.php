...
namespace PPGroup\Ccpp\Override\Payment\Block;
...
class Info extends BlockInfo
{
    ...
    protected function _prepareSpecificInformation($transport=null)
    {
        ...
        if(($parentBlock && $parentBlock instanceof \Magento\Sales\Block\Adminhtml\Order\Payment)
           || ($parentBlock && $parentBlock instanceof \Magento\Sales\Block\Adminhtml\Order\Payment && $this->escapeHtml($this->getMethod()->getTitle()) == "QR Code")) {
            ...
            if ($additionalInfo) {
                ...
                if (isset($additionalInfo['payment_channel']) === true
                    ...
                    $QRTitle = $this->_scopeConfig->getValue(self::QR_CODE_METHOD_TITLE_PATH);
                    if ($additionalInfo['method_title'] == $QRTitle) {
                        $paymentChannel = '006';
                    }
