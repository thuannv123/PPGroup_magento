...
namespace PPGroup\Klaviyo\Plugin;
...
class CheckoutLayoutPlugin
{
    ...
    public function afterProcess(\Magento\Checkout\Block\Checkout\LayoutProcessor $processor, $jsLayout)
    {
        ...
        if ($this->_klaviyoScopeSetting->getConsentAtCheckoutEmailIsActive()) {
            ...
            if (!$address) {
                $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['afterMethods']['children']['kl_sms_consent'] = $emailConsentCheckbox;
            } else {
                ...
                $emailConsentEmail = [
                    ...
                    'disabled' => true,
                    'visible' => false,
                    'value' => $address && $address->getEmail() ? $address->getEmail() : $this->_customerSession->getCustomer()->getEmail(),
                ];

                $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['afterMethods']['children']['kl_email'] = $emailConsentEmail;
                $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['afterMethods']['children']['kl_sms_consent'] = $emailConsentCheckbox;
            }
        }
        return $jsLayout;
