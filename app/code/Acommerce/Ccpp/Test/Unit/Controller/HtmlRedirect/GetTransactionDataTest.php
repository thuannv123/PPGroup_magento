...
use Acommerce\Ccpp\Controller\HtmlRedirect\GetTransactionData;
use Acommerce\Ccpp\Model\Api\PlaceTransactionService;

/**
 * Class GetTransactionDataTest
 * @package Acommerce\Ccpp\Test\Unit\Controller\HtmlRedirect
 * @see Acommerce\Ccpp\Controller\HtmlRedirect\GetTransactionData
 */
class GetTransactionDataTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->placeTransactionServiceMock = $this->getMockBuilder('Acommerce\Ccpp\Model\Api\PlaceTransactionService')
            ->disableOriginalConstructor()
            ->getMock();
    }

    /**
     * @covers \Acommerce\Ccpp\Controller\HtmlRedirect\GetTransactionData::execute
     * @return void
     */
    ...
    public function dataProviderTestExecute()
    {
        return [
            [
                'response' => [
                    'action' => 'ccpp sandbox url must be here',
                    'fields' => [
