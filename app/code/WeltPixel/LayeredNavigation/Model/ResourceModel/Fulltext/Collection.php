...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
    ...
    public function addFieldToFilter($field, $condition = null)
    {
        ...
        if (is_array($condition) && $this->_isElasticOrOpenSearchEngine()) {
    ...
    protected function _renderFiltersBefore()
    {
        ...
        if ($this->_isElasticOrOpenSearchEngine()) {
     ...
     * @return bool
     */
    protected function _isElasticOrOpenSearchEngine()
    {
        $currentEngine = $this->_scopeConfig->getValue(EngineInterface::CONFIG_ENGINE_PATH, ScopeInterface::SCOPE_STORE);

        if ($currentEngine == 'elasticsearch' || $currentEngine == 'elasticsearch5' || $currentEngine == 'elasticsearch6'
            || $currentEngine == 'elasticsearch7' || $currentEngine == 'opensearch') {
            return true;
        }
