...
namespace Amasty\Blog\Block\Adminhtml\System\Config;
...
class Information extends \Magento\Config\Block\System\Config\Form\Fieldset
{
     ...
     * @var string
     */
    private $userGuide = 'https://amasty.com/docs/doku.php?id=magento_2:blog_pro';
    ...
    public function getAdditionalModuleContent()
    {
        ...
        if ($this->moduleManager->isEnabled('Magento_PageBuilder')
            && !$this->moduleManager->isEnabled('Amasty_BlogPageBuilder')
        ) {
            $message = [
                'type' => 'message-notice',
                'text' => __('Enable blogpagebuilder module to activate PageBuilder and Blog Pro integration. '
                    . 'Please, run the following command in the SSH: composer require amasty/blog-page-builder')
            ];
